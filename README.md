...
| Device | Network / VLAN | IP Address | Subnet Mask | Default Gateway |
|---|---|---|---|---|
| HQ-PC1 | VLAN 10 - ADMIN | `10.10.10.11` | `255.255.255.0` | `10.10.10.1` |
| HQ-PC2 | VLAN 20 - HR | `10.10.20.11` | `255.255.255.0` | `10.10.20.1` |
| HQ-PC3 | VLAN 30 - IT | `10.10.30.11` | `255.255.255.0` | `10.10.30.1` |
| HQ-PC4 | VLAN 40 - USERS | `10.10.40.11` | `255.255.255.0` | `10.10.40.1` |
| HQ-PC5 | VLAN 50 - GUEST | `10.10.50.11` | `255.255.255.0` | `10.10.50.1` |
| HQ-PC6 | VLAN 10 - ADMIN | `10.10.10.12` | `255.255.255.0` | `10.10.10.1` |
| HQ-SRV | VLAN 60 - SERVER | `10.10.60.10` | `255.255.255.0` | `10.10.60.1` |
| BR1-PC1 | VLAN 110 - BR1-USERS | `10.11.10.11` | `255.255.255.0` | `10.11.10.1` |
| BR1-PC2 | VLAN 110 - BR1-USERS | `10.11.10.12` | `255.255.255.0` | `10.11.10.1` |
| BR1-PC3 | VLAN 120 - BR1-ADMIN | `10.11.20.11` | `255.255.255.0` | `10.11.20.1` |
| BR1-PC4 | VLAN 120 - BR1-ADMIN | `10.11.20.12` | `255.255.255.0` | `10.11.20.1` |
| BR2-PC1 | VLAN 210 - BR2-USERS | `10.12.10.11` | `255.255.255.0` | `10.12.10.1` |
| BR2-PC2 | VLAN 210 - BR2-USERS | `10.12.10.12` | `255.255.255.0` | `10.12.10.1` |
| BR2-PC3 | VLAN 220 - BR2-ADMIN | `10.12.20.11` | `255.255.255.0` | `10.12.20.1` |
| BR2-PC4 | VLAN 220 - BR2-ADMIN | `10.12.20.12` | `255.255.255.0` | `10.12.20.1` |
| DMZ-WEB | DMZ | `172.16.10.10` | `255.255.255.0` | `172.16.10.1` |
